<template>
  <div>
    ...
    <section class="pt-20 pb-40">
      <SectionTitle
        :title="'Expertise'"
        :label="'Specializing in experiences'"
      />
      ...
      <div class="container flex flex-col gap-5">
        <div class="custom-grid gap-y-5">
          ...
          <div class="col-start-1 col-end-4">
            <p class="medium indent-10">
              We offer eight transformation pathways, each built around a
        ...
        <div class="custom-grid gap-y-5">
          ...
          <div class="col-start-1 col-end-4">
            <p class="medium indent-10">
              Though we don’t believe awards are a measurement of success, we
              got them.
            </p>
          </div>
          <div class="col-start-5 col-end-13 -mt-2 flex flex-col gap-1">
